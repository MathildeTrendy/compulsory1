...
namespace compulsory1.Migrations
{
    ...
    [Migration("20250926094344_V7_ChangeCreditsToDecimal")]
    partial class V7_ChangeCreditsToDecimal
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("compulsory1.Models.Department", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("compulsory1.Models.Department", b =>
                {
                    b.HasOne("compulsory1.Models.Instructor", "DepartmentHead")
                        .WithMany()
            ...
            modelBuilder.Entity("compulsory1.Models.Enrollment", b =>
                {
                    ...
                    b.HasOne("compulsory1.Models.Student", "Student")
                        .WithMany("Enrollments")
